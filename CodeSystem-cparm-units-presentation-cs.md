...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/Terminologias/CodeSystem/cparm-units-presentation-cs | *Version*:1.0.0 |
| Active as of 2026-06-17 | *Computable Name*:CPARMUnitsPresentationCS |
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/Terminologias/CodeSystem/cparm-units-presentation-cs",
  "version" : "1.0.0",
