# CPE - AUDIT Result - HL7 PT FHIR Implementation Guide: Terminologias v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CPE - AUDIT Result**

## ValueSet: CPE - AUDIT Result 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/Terminologias/ValueSet/cpe-auditresult-vs | *Version*:1.0.0 |
| Active as of 2024-11-01 | *Computable Name*:CPEAUDITResultVS |
| *Other Identifiers:*OID:2.16.620.1.101.10.4.6.119 | |

 
Conjunto de valores AUDITResult (CPE v2.0.0). 
...
```json
{
  ...
  "id" : "cpe-auditresult-vs",
  "url" : "https://hl7.pt/fhir/Terminologias/ValueSet/cpe-auditresult-vs",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.620.1.101.10.4.6.119"
  }],
  "version" : "1.0.0",
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "LA32279-4",
        "display" : "Sim, mas não nos últimos 12 meses",
        "designation" : [{
          "language" : "en",
      ...
      {
        "code" : "LA32280-2",
        "display" : "Sim, aconteceu nos últimos 12 meses",
        "designation" : [{
          "language" : "en",
