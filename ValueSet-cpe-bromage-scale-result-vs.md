# CPE - Bromage Scale Result - HL7 PT FHIR Implementation Guide: Terminologias v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CPE - Bromage Scale Result**

## ValueSet: CPE - Bromage Scale Result 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/Terminologias/ValueSet/cpe-bromage-scale-result-vs | *Version*:1.0.0 |
| Active as of 2025-11-01 | *Computable Name*:CPEBromageScaleResultVS |
| *Other Identifiers:*OID:2.16.620.1.101.10.4.6.187 | |

 
Conjunto de valores BromageScaleResult (CPE v2.0.0). 
