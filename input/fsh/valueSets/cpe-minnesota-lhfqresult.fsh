// CPE v2.0.0 - Minnesota LHFQ Result
Instance: cpe-minnesota-lhfqresult-vs
InstanceOf: ValueSet
Usage: #definition

// * url  = "https://hl7.pt/fhir/ValueSet/cpe-minnesota-lhfqresult-vs"
...
* identifier[0].value = "urn:oid:2.16.620.1.101.10.4.6.136"
