...
As terminologias são um dos pilares do FHIR. Permitem garantir que sistemas diferentes utilizam os mesmos códigos para representar conceitos clínicos, administrativos ou organizacionais. Exemplos:

| Conceito | Código | Sistema | |———–|———-|———-| | Masculino | male | AdministrativeGender | | Diabetes Mellitus | 44054006 | SNOMED CT | | Hemoglobina | 718-7 | LOINC | | Portugal | PRT | ISO 3166 | Sem terminologias normalizadas, cada sistema poderia utilizar valores diferentes:

```text Masculino M Male Homem 1
...
Recurso Função CodeSystem Define códigos ValueSet Seleciona códigos permitidos ConceptMap Mapeia códigos entre sistemas NamingSystem Descreve identificadores externos
...
{ "resourceType": "CodeSystem", "url": "https://hl7.pt/fhir/CodeSystem/color", "version": "1.0.0", "status": "active", "content": "complete", "concept": [ { "code": "red", "display": "Red" }, { "code": "blue", "display": "Blue" } ] }

Neste exemplo:

Código Display red Red blue Blue
...
{ "resourceType": "ValueSet", "url": "https://hl7.pt/fhir/ValueSet/warm-colors", "version": "1.0.0", "compose": { "include": [ { "system": "https://hl7.pt/fhir/CodeSystem/color", "concept": [ { "code": "red" } ] } ] } }
...
CodeSystem ├── red ├── blue ├── green └── yellow ValueSet A ├── red └── yellow ValueSet B ├── blue └── green
...
https://hl7.pt/fhir/CodeSystem/color https://hl7.pt/fhir/ValueSet/warm-colors
...
URL: https://hl7.pt/fhir/CodeSystem/color Versão: 1.0.0 2.0.0 3.0.0

Errado:

https://hl7.pt/fhir/CodeSystem/color-v1 https://hl7.pt/fhir/CodeSystem/color-v2

Exemplo:

{ "url": "https://hl7.pt/fhir/CodeSystem/color", "version": "2.0.0" }
...
1. Existe um binding?
1. O código pertence ao ValueSet?
1. O sistema está correto?
1. A versão está correta?
...
GET [base]/ValueSet/$expand?url=https://hl7.pt/fhir/ValueSet/warm-colors

Exemplo:

GET https://tx.hl7.pt/fhir/ValueSet/$expand?url=https://hl7.pt/fhir/ValueSet/warm-colors

Resposta:

{ "expansion": { "contains": [ { "code": "red", "display": "Red" } ] } }
...
GET [base]/ValueSet/$validate-code ?url=https://hl7.pt/fhir/ValueSet/warm-colors &code=red
...
GET [base]/CodeSystem/$lookup ?system=https://hl7.pt/fhir/CodeSystem/color &code=red
...
Excel ↓ CodeSystem ↓ ValueSet ↓ Profile Binding ↓ FHIR Validator ↓ tx.hl7.pt
...
1. Versionar apenas com version

url = constante version = variável

1. Publicar sempre CodeSystem e ValueSet

Mesmo quando o ValueSet inclui todos os códigos.

1. Utilizar bindings Required sempre que possível

(required)

Melhora a interoperabilidade.

1. Manter versões anteriores acessíveis

CodeSystem ├── 1.0.0 ├── 2.0.0 └── 3.0.0

Permite reproduzir implementações antigas.

1. Utilizar o tx.hl7.pt para testes
