...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.pt/fhir/Terminologias/CodeSystem/mcdts-d-m-nuclear-cs | *Version*:1.0.0 |
| Active as of 2026-06-17 | *Computable Name*:MCDTSD_MNuclearCS |
...
```json
{
  ...
  "url" : "https://hl7.pt/fhir/Terminologias/CodeSystem/mcdts-d-m-nuclear-cs",
  "version" : "1.0.0",
